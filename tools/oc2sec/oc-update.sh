...
$TOOLS_DIR/file2mod.py $OCDIR $TEMP_DIR_MOD $CAROUSEL_ID $CAROUSEL_ID $ASSOCIATION_TAG $MODULE_VERSION $BLOCK_SIZE $UPDATE_FLAG $COMPRESS_MODE
...
$TOOLS_DIR/mod2sec.py $TEMP_DIR_MOD $TEMP_DIR_SEC
...
then
	...
	$TOOLS_DIR/sec2ts $PID < $TEMP_DIR_SEC/temp_sec > $OCDIR.ts
fi
